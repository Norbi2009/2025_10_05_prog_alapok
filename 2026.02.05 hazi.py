# HF 
# Szimuláljon egy matematika versenyt és az eredményeire készített statisztikát! Mind a 17 diák nagyon ügyes, így kevés rossz verseny dolgozat született.
# A döntőbe jutásésrt 70%-ot el kell érni.
...
def listaTerjedelem(lista):
    maximum = listaMaxmimuma(lista)
...
def main():
    ...
    terjedelem = listaTerjedelem(pontok)
    print(terjedelem)
    ...
    print(darab,"darab tanuló jutott a döntőbe")
